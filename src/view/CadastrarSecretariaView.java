 ...
 * @since 30/05/2020
 */
public class CadastrarSecretariaView {
	...
	public void iniciaGui() throws ParseException {
		...
		lbRamal.setBounds(20, 160, 50, 20);
		tfRamal.setBounds(65, 160, 200, 30);
		...
		painelDaJanela.add(lbRamal);
		painelDaJanela.add(tfRamal);
		...
		janela.setTitle("Cadastro de secretaria");
	...
	public void salvar() {
		if (validarDados()) {
			...
			secretaria.setCodigo(Integer.parseInt(tfCodigo.getText()));
			secretaria.setNome(tfNome.getText());
			secretaria.setCpf(tfCpf.getText());
			secretaria.setRg(tfRg.getText());
			secretaria.setSalario(Double.parseDouble(tfSalario.getText()));
			secretaria.setRamal(tfRamal.getText());

			new SecretariaController().gravarSecretaria(secretaria);
			limparDados();
